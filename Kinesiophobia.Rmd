...
Kinphob_r <- read.csv("2023-07-28_meta_analysis_kinesiophobia_r.csv", header = TRUE, sep = ",")
```
...
Kinphob_r$PA_obj_subj <- as.factor(Kinphob_r$PA_obj_subj)

PAobj_subg <- update.meta(m.cor, 
            subgroup = PA_obj_subj, 
            tau.common = TRUE)
PAobj_subg
```
...
## Sensitivity meta-analyses: Subgroup analyses
...
```{r PA outcome subgroup forest plot, fig.height=18, fig.width=7}
