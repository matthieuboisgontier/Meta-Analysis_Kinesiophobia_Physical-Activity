...
Kinphob_r <- read.csv("2023-08-02_meta_analysis_kinesiophobia_r.csv", 
                      header = TRUE, sep = ",")
```
...
A study's axis score (k = 41) did not influence correlation values. The R2 revealed that these variables explained less than 0.00% of the differences between study correlations. However, it should be noted that there was very littel variation in axis scores with all scores ranging between 16 and 18.
